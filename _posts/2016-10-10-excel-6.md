...
3. En la columnas de trimestres utilice los siguinetes formatos condicionales:
 a) Aplique el formato condicional de barras de datos con el color Naranja al Primer trimestre.
 b) Aplique el formato condicional de barras de datos con el color Amarillo al Segundo trimestre.
 c) Aplique el formato condicional de barras de datos con el color Rojo al Tercer trimestre.
